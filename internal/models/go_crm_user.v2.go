...
type GoCrmUserV2 struct {
	UsrID            int32  `gorm:"column:usr_id;primaryKey;autoIncrement:true;comment:Account ID" json:"usr_id"`
	UsrEmail         string `gorm:"column:usr_email;not null;comment:Email" json:"usr_email"`
	UsrPhone         string `gorm:"column:usr_phone;not null;comment:Phone Number" json:"usr_phone"`
	...
	UsrStatus        bool   `gorm:"column:usr_status;not null;comment:Status 1:enable, 0:disable" json:"usr_status"`
}
